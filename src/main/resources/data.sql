...
INSERT IGNORE INTO user (ENABLED, FIRST_NAME, LAST_NAME, PASSWORD, USERNAME, CREATE_USER_USERNAME, CREATE_DATE, INTERVALL) VALUES(TRUE, 'Spaß', 'Vogel', '$2a$10$Mk/CZDjQgLiWd0veXxVKguSamdmUsBJqsgaiCFPx8inYP4.E1rNgO', 'user70', 'admin', '2016-01-01 00:00:00', 'NONE')
INSERT INTO user_user_role (USER_USERNAME, ROLES) VALUES ('user70', 'EMPLOYEE')
INSERT IGNORE INTO user (ENABLED, FIRST_NAME, LAST_NAME, PASSWORD, USERNAME, CREATE_USER_USERNAME, CREATE_DATE, INTERVALL) VALUES(TRUE, 'Hunde', 'Sohn', '$2a$10$Mk/CZDjQgLiWd0veXxVKguSamdmUsBJqsgaiCFPx8inYP4.E1rNgO', 'user71', 'admin', '2016-01-01 00:00:00', 'NONE')
INSERT INTO user_user_role (USER_USERNAME, ROLES) VALUES ('user71', 'EMPLOYEE')
INSERT INTO user_user_role (USER_USERNAME, ROLES) VALUES ('user71', 'TEAMLEADER')
INSERT IGNORE INTO user (ENABLED, FIRST_NAME, LAST_NAME, PASSWORD, USERNAME, CREATE_USER_USERNAME, CREATE_DATE, INTERVALL) VALUES(TRUE, 'Ratten', 'Fänger', '$2a$10$Mk/CZDjQgLiWd0veXxVKguSamdmUsBJqsgaiCFPx8inYP4.E1rNgO', 'user72', 'admin', '2016-01-01 00:00:00', 'NONE')
INSERT INTO user_user_role (USER_USERNAME, ROLES) VALUES ('user72', 'EMPLOYEE')
INSERT INTO user_user_role (USER_USERNAME, ROLES) VALUES ('user72', 'DEPARTMENTLEADER')